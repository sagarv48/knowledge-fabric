...
Goal:
Build a vendor-neutral evidence retrieval platform. This project must not contain Acme-specific references, workflow execution, approvals, case creation, or runtime enterprise actions.

Hard constraints:
- Do not add Acme integration.
...
- No Acme-specific terms appear in source code or docs except in examples clearly marked as external/private adapter examples.
